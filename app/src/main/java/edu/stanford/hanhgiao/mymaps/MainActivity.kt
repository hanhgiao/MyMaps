package edu.stanford.hanhgiao.mymaps
...
import edu.stanford.hanhgiao.mymaps.models.Place
import edu.stanford.hanhgiao.mymaps.models.UserMap
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showAlertDialog() {
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener {
            ...
            if (title.trim().isEmpty()) {
                Toast.makeText(this, "Map must have non-empty title and description", Toast.LENGTH_LONG).show()
    ...
    private fun getDataFile(context: Context) : File {
        Log.i(TAG, "Getting file from direcoty ${context.filesDir}")
